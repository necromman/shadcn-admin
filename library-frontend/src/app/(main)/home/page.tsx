...
export default function HomePage() {
  const quickServices = [
    { icon: Search, title: '자료검색', link: '/search' },
    { icon: Calendar, title: '좌석예약', link: '/facilities/seat' },
    { icon: BookOpen, title: '희망도서', link: '/services/book-request' },
    { icon: Users, title: '대출연장', link: '/my-library' },
  ]
  ...
  const newBooks = [
    { id: 1, title: '도서관의 미래', author: '김도서', cover: 'https://via.placeholder.com/150x200' },
    { id: 2, title: '디지털 라이브러리', author: '이정보', cover: 'https://via.placeholder.com/150x200' },
    { id: 3, title: '지식의 숲', author: '박학습', cover: 'https://via.placeholder.com/150x200' },
    { id: 4, title: '독서의 즐거움', author: '최책읽', cover: 'https://via.placeholder.com/150x200' },
  ]
          ...
          <Link key={service.title} to={service.link}>
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="flex flex-col items-center justify-center p-6">
                <service.icon className="h-12 w-12 mb-3 text-blue-600" />
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span>제1열람실</span>
                  <span className="text-blue-600">65/100석</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>제2열람실</span>
                  <span className="text-blue-600">45/80석</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>스터디룸</span>
                  <span className="text-blue-600">3/10실</span>
                </div>
              </div>
            </div>
            <Button className="w-full" asChild>
              <Link to="/facilities/seat">좌석 예약하기</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
