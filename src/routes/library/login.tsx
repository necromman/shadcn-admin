...
import { LoginPage } from '@/library-frontend/src/app/auth/login'

export const Route = createFileRoute('/library/login')({
  component: LibraryLoginLayout,
})

function LibraryLoginLayout() {
  return (
